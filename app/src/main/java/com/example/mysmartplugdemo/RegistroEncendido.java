...
public class RegistroEncendido extends AppCompatActivity {
    // ESTO SERÍA PARA HACERLO CON EL REGISTRO DEL HISTORIAL DE TUYA
        ...
        TuyaHomeSdk.getRequestInstance().requestWithApiName("tuya.m.smart.operate.all.log", "1.0",
                requestParams, String.class, new ITuyaDataCallback<String>() {
                    ...
                    public void onError(String errorCode, String errorMessage) {
                        ...
                        Toast.makeText(RegistroEncendido.this, "Error requesting device history. ", Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
